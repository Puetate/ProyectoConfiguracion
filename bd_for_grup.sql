...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 24-07-2021 a las 17:34:54
...
CREATE TABLE `publicacion` (
  ...
  `TIT_PUB` varchar(50) COLLATE utf8_unicode_ci NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
...
INSERT INTO `publicacion` (`ID_PUB`, `CED_USU_PUB`, `IMG_PUB`, `DES_PUB`, `TIT_PUB`) VALUES
(1, '9876543210', NULL, 'ESTO ES UN EJEMPLO DE PUBLICACION REALIZADA POR EL USUARIO 2\r\n-ITEMS A TRATAR\r\n-PUNTOS IMPORTANTES\r\n(\"CARACTERES ESPECIALES\")', 'PUBLICACION USUARIO 2'),
(2, '1234567890', NULL, 'ESTO ES UNA PUBLICACION REALIZADA POR EL USUARIO ADMINISTRADOR\r\n-USUARIO: ADMI\r\n-CONTRASEÑA: ADMI', 'PUBLICACION DEL ADMINISTRADOR');
...
CREATE TABLE `usuario` (
  ...
  `CORR_USU` varchar(40) COLLATE utf8_unicode_ci NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
...
INSERT INTO `usuario` (`CED_USU`, `NOM_USU`, `APE_USU`, `FEC_NAC`, `FOT_USU`, `NIC_USU`, `CONT_USU`, `CORR_USU`) VALUES
('0123456789', 'USU', 'USU', '1997-07-01', NULL, 'USU', '$2y$10$kODisFRpCBhKfhRTYFojLOTwKKq3WzwixsRHOGWSOZaFlPNTvd1H2', 'usu@uta.edu.ec'),
('1234567890', 'ADMIN', 'ADMIN', '1997-08-11', NULL, 'ADMIN', '$2y$10$GdX2Y.kRYzY/Y9PyroOyhePacqdjvMx3mCPcKUvcc8IX/N4sYuYRa', 'admin@uta.edu.ec'),
('9876543210', 'USUARIO2', 'USUARIO2', '1991-07-09', NULL, 'USU2', 'USU2', 'usu2@uta.edu.ec');
